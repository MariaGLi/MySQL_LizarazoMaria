CREATE DATABASE Diagrama_Jardineria;

USE Diagrama_Jardineria;
...
SELECT nombre, apellido1, apellido2, puesto FROM empleado WHERE puesto != "Representante Ventas"; -- != es un operador de desigualdad que significa "distinto de"

-- Devuelve un listado con el nombre de todos los clientes españoles.
SELECT nombre_cliente FROM cliente WHERE pais='Spain';

-- Devuelve un listado con los distintos estados por los que puede pasar un pedido.
SELECT DISTINCT estado FROM pedido; -- DISTINCT elimina los valores repetidos de la consulta.
...
-- EJEMPLO: SELECT column_name(s) FROM table_name WHERE column_name BETWEEN value1 AND value2;
...
-- DESC ordena los valores de una columna de manera descendente, es decir, del valor máximo al mínimo
